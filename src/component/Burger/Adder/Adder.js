    ...
    <>
      <div className="btnContainer">
        ...
        <div className="rows p-1">
          ...
          <button
            className="btns"
            onClick={() => addHandler(Object.keys(disable)[0], 7)}
          >
            Add
          </button>
          <button
            className={disable.lettuce ? "disabled" : "btns"}
            onClick={() => removeHandler(Object.keys(disable)[0], 7)}
          >
            Remove
          </button>
        </div>
        <div className="rows p-1">
          ...
          <button
            className="btns"
            onClick={() => addHandler(Object.keys(disable)[1], 8)}
          >
            Add
          </button>
          <button
            className={disable.tomato ? "disabled" : "btns"}
            onClick={() => removeHandler(Object.keys(disable)[1], 8)}
          >
            Remove
          </button>
        </div>
        <div className="rows">
          ...
          <button
            className="btns"
            onClick={() => addHandler(Object.keys(disable)[2], 5)}
          >
            Add
          </button>
          <button
            className={disable.onion ? "disabled" : "btns"}
            onClick={() => removeHandler(Object.keys(disable)[2], 5)}
          >
            Remove
          </button>
        </div>
        <div className="rows">
          ...
          <button
            className="btns"
            onClick={() => addHandler(Object.keys(disable)[3], 10)}
          >
            Add
          </button>
          <button
            className={disable.cheese ? "disabled" : "btns"}
            onClick={() => removeHandler(Object.keys(disable)[3], 10)}
          >
            Remove
          </button>
        </div>
        <div className="rows">
          ...
          <button
            className="btns"
            onClick={() => addHandler(Object.keys(disable)[4], 20)}
          >
            Add
          </button>
          <button
            className={disable.beef ? "disabled" : "btns"}
            onClick={() => removeHandler(Object.keys(disable)[4], 20)}
          >
            Remove
          </button>
        </div>
        <div className=" text-center">
          <button className="checkBtn" onClick={checkoutHandler}>
            Checkout
          </button>
        </div>
      </div>
