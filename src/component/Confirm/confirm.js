        ...
        : [
            {
              ...
              FirstName: "vishak",
              LastName: "T V",
              email: "vishakvenu91@gmail.com",
              street: "Thaivelikakth",
              pincode: "682301",
              address: "Thaivelikakth 2n floor",
              select: "cod",
            },
          ];
          ...
          <Card.Body>
            ...
            <div className="text-center my-4 d-flex justify-content-around ">
              <Button variant="success" onClick={submitHandler}>
                {btnValue ? "Loading...." : "Place Order Now"}
              </Button>
